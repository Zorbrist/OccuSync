        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input 
              ...
              placeholder="Search ID, provider, or notes..." 
          ...
          {filteredOrders.map((order) => (
            ...
            >
              ...
              <div>
                ...
                {order.notes && (
                  <p className="text-slate-400 text-sm mb-6 bg-slate-950/50 border border-slate-800/50 p-4 rounded-xl line-clamp-2 leading-relaxed">
                    "{order.notes}"
                  </p>
                )}
              </div>
              ...
              <div className="pt-5 mt-auto border-t border-slate-800/50 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-slate-300 leading-none">
